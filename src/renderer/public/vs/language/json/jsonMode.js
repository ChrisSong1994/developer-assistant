...
define("vs/language/json/jsonMode", ["require", "require"], (require)=>{
    var moduleExports = (()=>{
        ...
        var xn = (e=>typeof require != "undefined" ? require : typeof Proxy != "undefined" ? new Proxy(e,{
        ...
        t.exports)
          ...
          , te = (e,t,i,r)=>{
            if (t && typeof t == "object" || typeof t == "function")
                for (let n of Cn(t))
                    !In.call(e, n) && n !== i && ie(e, n, {
                        get: ()=>t[n],
                        enumerable: !(r = bn(t, n)) || r.enumerable
                    });
            return e
        }
          , Ee = (e,t,i)=>(te(e, t, "default"),
        i && te(i, t, "default"))
          , _e = (e,t,i)=>(i = e != null ? Tn(wn(e)) : {},
        te(t || !e || !e.__esModule ? ie(i, "default", {
            value: e,
            enumerable: !0
        }) : i, e))
          , Pn = e=>te(ie({}, "__esModule", {
            value: !0
        }), e);
        var Se = En((gr,Pe)=>{
        ...
        var An = 2 * 60 * 1e3
          , D = class {
            ...
            _stopWorker() {
                this._worker && (this._worker.dispose(),
                this._worker = null),
                this._client = null
            }
            dispose() {
            ...
            _getClient() {
                ...
                this._client || (this._worker = l.editor.createWebWorker({
        ...
        (function(e) {
            function t(r, n) {
                return r === Number.MAX_VALUE && (r = oe.MAX_VALUE),
        ...
        (function(e) {
            ...
            function i(r) {
                var n = r;
                return s.defined(n) && k.is(n.range) && (s.string(n.uri) || s.undefined(n.uri))
            }
            e.is = i
        }
        )(ge || (ge = {}));
        ...
        (function(e) {
            ...
            function i(r) {
                var n = r;
                return s.defined(n) && k.is(n.targetRange) && s.string(n.targetUri) && (k.is(n.targetSelectionRange) || s.undefined(n.targetSelectionRange)) && (k.is(n.originSelectionRange) || s.undefined(n.originSelectionRange))
            }
            e.is = i
        }
        )(Le || (Le = {}));
        ...
        (function(e) {
            ...
            function i(r) {
                var n = r;
                return s.string(n.label) && (s.undefined(n.textEdit) || A.is(n)) && (s.undefined(n.additionalTextEdits) || s.typedArray(n.additionalTextEdits, A.is))
            }
            e.is = i
        }
        )(We || (We = {}));
        ...
        (function(e) {
            function t(r, n, a, o, u) {
                ...
                return s.defined(a) && (c.startCharacter = a),
        ...
        (function(e) {
            function t(r, n, a, o, u, c) {
                ...
                return s.defined(a) && (h.severity = a),
            ...
            function i(r) {
                var n, a = r;
                return s.defined(a) && k.is(a.range) && s.string(a.message) && (s.number(a.severity) || s.undefined(a.severity)) && (s.integer(a.code) || s.string(a.code) || s.undefined(a.code)) && (s.undefined(a.codeDescription) || s.string((n = a.codeDescription) === null || n === void 0 ? void 0 : n.href)) && (s.string(a.source) || s.undefined(a.source)) && (s.undefined(a.relatedInformation) || s.typedArray(a.relatedInformation, he.is))
            }
            e.is = i
        }
        )(se || (se = {}));
        ...
        (function(e) {
            function t(r, n, a) {
                ...
                return n !== void 0 && (o.needsConfirmation = n),
        ...
        (function(e) {
            function t(r, n, a) {
                ...
                return n !== void 0 && (n.overwrite !== void 0 || n.ignoreIfExists !== void 0) && (o.options = n),
            ...
            function i(r) {
                var n = r;
                return n && n.kind === "create" && s.string(n.uri) && (n.options === void 0 || (n.options.overwrite === void 0 || s.boolean(n.options.overwrite)) && (n.options.ignoreIfExists === void 0 || s.boolean(n.options.ignoreIfExists))) && (n.annotationId === void 0 || T.is(n.annotationId))
            }
            e.is = i
        }
        )(H || (H = {}));
        ...
        (function(e) {
            ...
            function i(r) {
                var n = r;
                return n && n.kind === "rename" && s.string(n.oldUri) && s.string(n.newUri) && (n.options === void 0 || (n.options.overwrite === void 0 || s.boolean(n.options.overwrite)) && (n.options.ignoreIfExists === void 0 || s.boolean(n.options.ignoreIfExists))) && (n.annotationId === void 0 || T.is(n.annotationId))
            }
            e.is = i
        }
        )(J || (J = {}));
        ...
        (function(e) {
            function t(r, n, a) {
                ...
                return n !== void 0 && (n.recursive !== void 0 || n.ignoreIfNotExists !== void 0) && (o.options = n),
                a !== void 0 && (o.annotationId = a),
                o
            }
            e.create = t;
            function i(r) {
                var n = r;
                return n && n.kind === "delete" && s.string(n.uri) && (n.options === void 0 || (n.options.recursive === void 0 || s.boolean(n.options.recursive)) && (n.options.ignoreIfNotExists === void 0 || s.boolean(n.options.ignoreIfNotExists))) && (n.annotationId === void 0 || T.is(n.annotationId))
            }
            e.is = i
        }
        )(B || (B = {}));
        ...
        (function(e) {
            function t(i) {
                var r = i;
                return r && (r.changes !== void 0 || r.documentChanges !== void 0) && (r.documentChanges === void 0 || r.documentChanges.every(function(n) {
        ...
        var ae = function() {
            function e(t, i) {
                this.edits = t,
                this.changeAnnotations = i
            }
            return e.prototype.insert = function(t, i, r) {
                var n, a;
                if (r === void 0 ? n = A.insert(t, i) : T.is(r) ? (a = r,
                n = S.insert(t, i, r)) : (this.assertChangeAnnotations(this.changeAnnotations),
            ...
            e.prototype.replace = function(t, i, r) {
                var n, a;
                if (r === void 0 ? n = A.replace(t, i) : T.is(r) ? (a = r,
                n = S.replace(t, i, r)) : (this.assertChangeAnnotations(this.changeAnnotations),
                a = this.changeAnnotations.manage(r),
                n = S.replace(t, i, a)),
                this.edits.push(n),
                a !== void 0)
            ...
            e.prototype.delete = function(t, i) {
                var r, n;
                if (i === void 0 ? r = A.del(t) : T.is(i) ? (n = i,
                r = S.del(t, i)) : (this.assertChangeAnnotations(this.changeAnnotations),
          ...
          , yr = function() {
            function e(t) {
                ...
                t.documentChanges ? (this._changeAnnotations = new Me(t.changeAnnotations),
            ...
            e.prototype.initDocumentChanges = function() {
                this._workspaceEdit.documentChanges === void 0 && this._workspaceEdit.changes === void 0 && (this._changeAnnotations = new Me,
            ...
            e.prototype.createFile = function(t, i, r) {
                ...
                var a, o;
                if (n === void 0 ? a = H.create(t, r) : (o = T.is(n) ? n : this._changeAnnotations.manage(n),
                a = H.create(t, r, o)),
                this._workspaceEdit.documentChanges.push(a),
                o !== void 0)
                    return o
            ...
            e.prototype.renameFile = function(t, i, r, n) {
                ...
                var o, u;
                if (a === void 0 ? o = J.create(t, i, n) : (u = T.is(a) ? a : this._changeAnnotations.manage(a),
                o = J.create(t, i, n, u)),
            ...
            e.prototype.deleteFile = function(t, i, r) {
                ...
                N.is(i) || T.is(i) ? n = i : r = i;
                var a, o;
                if (n === void 0 ? a = B.create(t, r) : (o = T.is(n) ? n : this._changeAnnotations.manage(n),
                a = B.create(t, r, o)),
                this._workspaceEdit.documentChanges.push(a),
                o !== void 0)
                    return o
        ...
        (function(e) {
            function t(i) {
                var r = i;
                return !!r && s.objectLiteral(r) && (ve.is(r.contents) || fe.is(r.contents) || s.typedArray(r.contents, fe.is)) && (i.range === void 0 || k.is(i.range))
            }
            e.is = t
        }
        )(ze || (ze = {}));
        ...
        (function(e) {
            function t(r, n, a, o, u, c) {
                ...
                return c !== void 0 && (h.children = c),
                h
            }
            e.create = t;
            function i(r) {
                var n = r;
                return n && s.string(n.name) && s.number(n.kind) && k.is(n.range) && k.is(n.selectionRange) && (n.detail === void 0 || s.string(n.detail)) && (n.deprecated === void 0 || s.boolean(n.deprecated)) && (n.children === void 0 || Array.isArray(n.children)) && (n.tags === void 0 || Array.isArray(n.tags))
            }
            e.is = i
        }
        )(Qe || (Qe = {}));
        ...
        (function(e) {
            function t(r, n) {
                ...
                return n != null && (a.only = n),
                a
            }
            e.create = t;
            function i(r) {
                var n = r;
                return s.defined(n) && s.typedArray(n.diagnostics, se.is) && (n.only === void 0 || s.typedArray(n.only, s.string))
            }
            e.is = i
        }
        )(en || (en = {}));
        ...
        (function(e) {
            function t(r, n, a) {
                var o = {
                  ...
                  , u = !0;
                return typeof n == "string" ? (u = !1,
                o.kind = n) : K.is(n) ? o.command = n : o.edit = n,
                u && a !== void 0 && (o.kind = a),
                o
            }
            e.create = t;
            function i(r) {
                var n = r;
                return n && s.string(n.title) && (n.diagnostics === void 0 || s.typedArray(n.diagnostics, se.is)) && (n.kind === void 0 || s.string(n.kind)) && (n.edit !== void 0 || n.command !== void 0) && (n.command === void 0 || K.is(n.command)) && (n.isPreferred === void 0 || s.boolean(n.isPreferred)) && (n.edit === void 0 || me.is(n.edit))
            }
            e.is = i
        }
        )(nn || (nn = {}));
        ...
        (function(e) {
            function t(r, n) {
                ...
                return s.defined(n) && (a.data = n),
                a
            }
            e.create = t;
            function i(r) {
                var n = r;
                return s.defined(n) && k.is(n.range) && (s.undefined(n.command) || K.is(n.command))
            }
            e.is = i
        }
        )(rn || (rn = {}));
        ...
        (function(e) {
            ...
            function i(r) {
                var n = r;
                return s.defined(n) && k.is(n.range) && (s.undefined(n.target) || s.string(n.target))
            }
            e.is = i
        }
        )(an || (an = {}));
        ...
        (function(e) {
            ...
            function i(r) {
                var n = r;
                return n !== void 0 && k.is(n.range) && (n.parent === void 0 || e.is(n.parent))
            }
            e.is = i
        }
        )(on || (on = {}));
...
` && n++
            ...
            constructor(t, i, r) {
                ...
                this._disposables.push(r(o=>{
                    l.editor.getModels().forEach(u=>{
                        u.getLanguageId() === this._languageId && (a(u),
                        n(u))
                    }
                    )
                }
        ...
        var X = class {
            ...
            provideCompletionItems(t, i, r, n) {
                let a = t.uri;
                return this._worker(a).then(o=>o.doComplete(a.toString(), L(i))).then(o=>{
                    if (!o)
                        return;
                    let u = t.getWordUntilPosition(i)
                      ...
                      , h = o.items.map(p=>{
                        ...
                        return p.textEdit && (Dn(p.textEdit) ? f.range = {
                        ...
                        p.insertTextFormat === le.Snippet && (f.insertTextRules = l.languages.CompletionItemInsertTextRule.InsertAsSnippet),
                        f
                    }
                    );
                    return {
        ...
        var Y = class {
            ...
            provideHover(t, i, r) {
                let n = t.uri;
                return this._worker(n).then(a=>a.doHover(n.toString(), L(i))).then(a=>{
                    if (!!a)
                        return {
                            range: C(a.range),
...
` + e.value + "\n```\n"
        ...
        function jn(e) {
            if (!!e)
                return Array.isArray(e) ? e.map(un) : [un(e)]
        }
        var ke = class {
            constructor(t) {
                this._worker = t
            ...
            provideDocumentHighlights(t, i, r) {
                let n = t.uri;
                return this._worker(n).then(a=>a.findDocumentHighlights(n.toString(), L(i))).then(a=>{
                    if (!!a)
                        return a.map(o=>({
                            range: C(o.range),
                            kind: Un(o.kind)
        ...
        var ye = class {
            ...
            provideDefinition(t, i, r) {
                let n = t.uri;
                return this._worker(n).then(a=>a.findDefinition(n.toString(), L(i))).then(a=>{
                    if (!!a)
                        return [cn(a)]
                }
                )
        ...
        var Te = class {
            ...
            provideReferences(t, i, r, n) {
                let a = t.uri;
                return this._worker(a).then(o=>o.findReferences(a.toString(), L(i))).then(o=>{
                    if (!!o)
                        return o.map(cn)
                }
                )
          ...
          , be = class {
            ...
            provideRenameEdits(t, i, r, n) {
                let a = t.uri;
                return this._worker(a).then(o=>o.doRename(a.toString(), L(i), r)).then(o=>Vn(o))
            }
        }
        ;
        function Vn(e) {
        ...
        var Ce = class {
          ...
          , G = class {
            ...
            provideDocumentFormattingEdits(t, i, r) {
                let n = t.uri;
                return this._worker(n).then(a=>a.format(n.toString(), null, ln(i)).then(o=>{
                    if (!(!o || o.length === 0))
                        return o.map(j)
                }
                ))
          ...
          , Q = class {
            ...
            provideDocumentRangeFormattingEdits(t, i, r, n) {
                let a = t.uri;
                return this._worker(a).then(o=>o.format(a.toString(), we(i), ln(r)).then(u=>{
                    if (!(!u || u.length === 0))
                        return u.map(j)
                }
                ))
        ...
        var Z = class {
            ...
            provideColorPresentations(t, i, r) {
                let n = t.uri;
                return this._worker(n).then(a=>a.getColorPresentations(n.toString(), i.color, we(i.range))).then(a=>{
                    if (!!a)
                        return a.map(o=>{
                            let u = {
                                label: o.label
                            };
                            return o.textEdit && (u.textEdit = j(o.textEdit)),
          ...
          , ee = class {
            ...
            provideFoldingRanges(t, i, r) {
                let n = t.uri;
                return this._worker(n).then(a=>a.getFoldingRanges(n.toString(), i)).then(a=>{
                    if (!!a)
                        return a.map(o=>{
                            let u = {
                                start: o.startLine + 1,
                            ...
                            return typeof o.kind < "u" && (u.kind = Hn(o.kind)),
                            u
                        }
                        )
                }
        ...
        var ne = class {
            ...
            provideSelectionRanges(t, i, r) {
                let n = t.uri;
                return this._worker(n).then(a=>a.getSelectionRanges(n.toString(), i.map(L))).then(a=>{
                    if (!!a)
                        return a.map(o=>{
                            let u = [];
                            for (; o; )
        ...
        function de(e, t) {
            ...
            function E() {
                ...
                if (e.charCodeAt(r) === 48)
                    ...
                    for (r++; r < e.length && U(e.charCodeAt(r)); )
                        r++;
...
`),
                ...
                case 47:
                    ...
                    if (e.charCodeAt(r + 1) === 47) {
                        for (r += 2; r < i && !re(e.charCodeAt(r)); )
                            r++;
                        return n = e.substring(w, r),
                        o = 12
                    }
                    ...
                    return n += String.fromCharCode(d),
                    r++,
                    o = 16;
                case 45:
                    if (n += String.fromCharCode(d),
                    r++,
        ...
        var P = class {
          ...
          , W = class {
            ...
            equals(t) {
                return t === this ? !0 : !t || !(t instanceof W) ? !1 : this.scanError === t.scanError && this.lastWasColon === t.lastWasColon && P.equals(this.parents, t.parents)
            }
            getStateData() {
                return this._state
            }
        ...
        var xe = class extends q {
            constructor(t, i, r) {
                ...
                this._disposables.push(l.editor.onWillDisposeModel(n=>{
                    this._resetSchema(n.uri)
                }
                )),
                this._disposables.push(l.editor.onDidChangeModelLanguage(n=>{
        ...
        function cr(e) {
            ...
            function a() {
                ...
                vn(i),
                c.documentFormattingEdits && i.push(l.languages.registerDocumentFormattingEditProvider(u, new G(n))),
                c.documentRangeFormattingEdits && i.push(l.languages.registerDocumentRangeFormattingEditProvider(u, new Q(n))),
                c.completionItems && i.push(l.languages.registerCompletionItemProvider(u, new X(n,[" ", ":", '"']))),
            ...
            a(),
            t.push(l.languages.setLanguageConfiguration(e.languageId, lr));
            let o = e.modeConfiguration;
            return e.onDidChange(u=>{
                u.modeConfiguration !== o && (o = u.modeConfiguration,
                a())
            }
            ),
            t.push(mn(i)),
